...
public class snsGalBoardVO {
	/*
	 * GALNUM NOT NULL VARCHAR2(50) 
	 * GALTITLE NOT NULL VARCHAR2(150)
	 * GALCONTENTS NOT NULL VARCHAR2(3000) 
	 * GALDATE NOT NULL DATE GALHITS NOT NULL NUMBER(4) ADMINID VARCHAR2(10)
	 */
	...
	public String toString() {
		return "snsGalBoardVO [galNum=" + galNum + ", galTitle=" + galTitle + ", galContents=" + galContents
