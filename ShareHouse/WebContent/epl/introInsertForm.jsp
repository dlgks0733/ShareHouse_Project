...
<section id="breadcrumb-section" class="breadcrumb-section w100dt mb-30">
	...
	<section id="error-section" class="error-section w100dt mb-50">
		...
		<form name="frm" method="post" action="epl?command=eplIntroInsertAction" onsubmit="return validateBoard()">
			<table class="centered">
					<tr>
						<th>동아리명 </th>
						<td><input type="text" name="intClubname"></td>
					</tr>
					
					<tr>
						<th>동아리 소개<hr></th>
						<td><textarea name="intContents"
						rows="28" cols="93" style="margin: 0px; width: 900px; height: 246px;"></textarea></td>
					</tr>
					<tr>
						<th>동아리 연혁<hr></th>
					...
					<tr>
						<th>동아리 회장 </th>
						<td><input type="text" name="intName"></td>
					</tr>
					<tr>
						<th>동아리 구성원<hr></th>
			...
			<div>	
				...
				onclick="location.href='epl?command=introductionFormAction'" value="취소">
