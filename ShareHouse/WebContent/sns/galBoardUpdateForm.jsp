					...
					<div class="blogs mb-30">
						<div class="card">
							...
							<div class="card-content w100dt">
								...
								<input type="text" value="${snsVo.galTitle}"
								...
								<p class="w100dt mb-50">
									<br>
									<textarea style="margin: 0px; width: 1090px; height: 125px;">${snsVo.galContents}</textarea>
								</p>

								<ul class="tag-list right">
									<li><a href="sns?command=snsGalBoardListFormAction"
										class="waves-effect">#목록</a></li>
									<li><a
										href="sns?command=snsGalBoardUpdateFormAction&galNum=${snsVo.galNum}"
										class="waves-effect">#수정</a></li>
									<li><a
										href="sns?command=snsGalBoardDeleteAction&galNum=${snsVo.galNum}"
